...
#define CCI_REG24_LE(n)				((3 << 16) | (n))
#define IMX296_REG_SIZE_SHIFT				16
#define IMX296_REG_ADDR_MASK				0xffff

#define IMX296_CTRL00					CCI_REG8(0x3000)
#define IMX296_CTRL00_STANDBY				BIT(0)
#define IMX296_CTRL08					CCI_REG8(0x3008)
#define IMX296_CTRL08_REGHOLD				BIT(0)
#define IMX296_CTRL0A					CCI_REG8(0x300a)
#define IMX296_CTRL0A_XMSTA				BIT(0)
#define IMX296_CTRL0B					CCI_REG8(0x300b)
#define IMX296_CTRL0B_TRIGEN				BIT(0)
#define IMX296_CTRL0D					CCI_REG8(0x300d)
...
#define IMX296_CTRL0E					CCI_REG8(0x300e)
#define IMX296_CTRL0E_VREVERSE				BIT(0)
#define IMX296_CTRL0E_HREVERSE				BIT(1)
#define IMX296_VMAX					    CCI_REG24_LE(0x3010)
#define IMX296_HMAX					    CCI_REG16_LE(0x3014)
#define IMX296_TMDCTRL					CCI_REG8(0x301d)
#define IMX296_TMDCTRL_LATCH				BIT(0)
#define IMX296_TMDOUT					CCI_REG16_LE(0x301e)
#define IMX296_TMDOUT_MASK				0x3ff
#define IMX296_WDSEL					CCI_REG8(0x3021)
#define IMX296_WDSEL_NORMAL				(0 << 0)
#define IMX296_WDSEL_MULTI_2				(1 << 0)
#define IMX296_WDSEL_MULTI_4				(3 << 0)
#define IMX296_BLKLEVELAUTO				CCI_REG8(0x3022)
#define IMX296_BLKLEVELAUTO_ON				0x01
#define IMX296_BLKLEVELAUTO_OFF				0xf0
#define IMX296_SST					    CCI_REG8(0x3024)
#define IMX296_SST_EN					BIT(0)
#define IMX296_CTRLTOUT					CCI_REG8(0x3026)
...
#define IMX296_CTRLTRIG					CCI_REG8(0x3029)
...
#define IMX296_SYNCSEL					CCI_REG8(0x3036)
#define IMX296_SYNCSEL_NORMAL				0xc0
#define IMX296_SYNCSEL_HIZ				0xf0
#define IMX296_PULSE1					CCI_REG8(0x306d)
...
#define IMX296_PULSE1_UP				CCI_REG24_LE(0x3070)
#define IMX296_PULSE1_DN				CCI_REG24_LE(0x3074)
#define IMX296_PULSE2					CCI_REG8(0x3079)
...
#define IMX296_PULSE2_UP				CCI_REG24_LE(0x307c)
#define IMX296_PULSE2_DN				CCI_REG24_LE(0x3080)
#define IMX296_INCKSEL(n)				CCI_REG8(0x3089 + (n))
#define IMX296_SHS1					    CCI_REG24_LE(0x308d)
#define IMX296_SHS2					    CCI_REG24_LE(0x3090)
#define IMX296_SHS3					    CCI_REG24_LE(0x3094)
#define IMX296_SHS4					    CCI_REG24_LE(0x3098)
#define IMX296_VBLANKLP					CCI_REG8(0x309c)
#define IMX296_VBLANKLP_NORMAL				0x04
#define IMX296_VBLANKLP_LOW_POWER			0x2c
#define IMX296_EXP_CNT					CCI_REG8(0x30a3)
#define IMX296_EXP_CNT_RESET				BIT(0)
#define IMX296_EXP_MAX					CCI_REG16_LE(0x30a6)
#define IMX296_VINT					    CCI_REG8(0x30aa)
#define IMX296_VINT_EN					BIT(0)
#define IMX296_LOWLAGTRG				CCI_REG8(0x30ae)
#define IMX296_LOWLAGTRG_FAST				BIT(0)
#define IMX296_I2CCTRL					CCI_REG8(0x30ef)
#define IMX296_I2CCTRL_I2CACKEN				BIT(0)

#define IMX296_SENSOR_INFO				CCI_REG16_LE(0x3148)
#define IMX296_SENSOR_INFO_MONO				BIT(15)
#define IMX296_SENSOR_INFO_IMX296LQ			0x4a00
#define IMX296_SENSOR_INFO_IMX296LL			0xca00
#define IMX296_S_SHSA					CCI_REG16_LE(0x31ca)
#define IMX296_S_SHSB					CCI_REG16_LE(0x31d2)
/*
...
#define IMX296_GAINCTRL					CCI_REG8(0x3200)
#define IMX296_GAINCTRL_WD_GAIN_MODE_NORMAL		0x01
#define IMX296_GAINCTRL_WD_GAIN_MODE_MULTI		0x41
#define IMX296_GAIN					    CCI_REG16_LE(0x3204)
#define IMX296_GAIN_MIN					0
#define IMX296_GAIN_MAX					480
#define IMX296_GAIN1					CCI_REG16_LE(0x3208)
#define IMX296_GAIN2					CCI_REG16_LE(0x320c)
#define IMX296_GAIN3					CCI_REG16_LE(0x3210)
#define IMX296_GAINDLY					CCI_REG8(0x3212)
#define IMX296_GAINDLY_NONE				0x08
#define IMX296_GAINDLY_1FRAME				0x09
#define IMX296_PGCTRL					CCI_REG8(0x3238)
...
#define IMX296_PGHPOS					CCI_REG16_LE(0x3239)
#define IMX296_PGVPOS					CCI_REG16_LE(0x323c)
#define IMX296_PGHPSTEP					CCI_REG8(0x323e)
#define IMX296_PGVPSTEP					CCI_REG8(0x323f)
#define IMX296_PGHPNUM					CCI_REG8(0x3240)
#define IMX296_PGVPNUM					CCI_REG8(0x3241)
#define IMX296_PGDATA1					CCI_REG16_LE(0x3244)
#define IMX296_PGDATA2					CCI_REG16_LE(0x3246)
#define IMX296_PGHGSTEP					CCI_REG8(0x3249)
#define IMX296_BLKLEVEL					CCI_REG16_LE(0x3254)

#define IMX296_FID0_ROI					CCI_REG8(0x3300)
#define IMX296_FID0_ROIH1ON				BIT(0)
#define IMX296_FID0_ROIV1ON				BIT(1)
#define IMX296_FID0_ROIPH1				CCI_REG16_LE(0x3310)
#define IMX296_FID0_ROIPV1				CCI_REG16_LE(0x3312)
#define IMX296_FID0_ROIWH1				CCI_REG16_LE(0x3314)
#define IMX296_FID0_ROIWH1_MIN				80
#define IMX296_FID0_ROIWV1				CCI_REG16_LE(0x3316)
#define IMX296_FID0_ROIWV1_MIN				4

#define IMX296_CM_HSST_STARTTMG				CCI_REG16_LE(0x4018)
#define IMX296_CM_HSST_ENDTMG				CCI_REG16_LE(0x401a)
#define IMX296_DA_HSST_STARTTMG				CCI_REG16_LE(0x404d)
#define IMX296_DA_HSST_ENDTMG				CCI_REG16_LE(0x4050)
#define IMX296_LM_HSST_STARTTMG				CCI_REG16_LE(0x4094)
#define IMX296_LM_HSST_ENDTMG				CCI_REG16_LE(0x4096)
#define IMX296_SST_SIEASTA1_SET				CCI_REG8(0x40c9)
#define IMX296_SST_SIEASTA1PRE_1U			CCI_REG16_LE(0x40cc)
#define IMX296_SST_SIEASTA1PRE_1D			CCI_REG16_LE(0x40ce)
#define IMX296_SST_SIEASTA1PRE_2U			CCI_REG16_LE(0x40d0)
#define IMX296_SST_SIEASTA1PRE_2D			CCI_REG16_LE(0x40d2)
#define IMX296_HSST					CCI_REG8(0x40dc)
#define IMX296_HSST_EN					BIT(2)

#define IMX296_CKREQSEL					CCI_REG8(0x4101)
#define IMX296_CKREQSEL_HS				BIT(2)
#define IMX296_GTTABLENUM				CCI_REG8(0x4114)
#define IMX296_CTRL418C					CCI_REG8(0x418c)
...
struct cci_reg_sequence imx296_init_table[] = {
	{ CCI_REG8(0x3005), 0xf0 },
	{ CCI_REG8(0x309e), 0x04 },
	{ CCI_REG8(0x30a0), 0x04 },
	{ CCI_REG8(0x30a1), 0x3c },
	{ CCI_REG8(0x30a4), 0x5f },
	{ CCI_REG8(0x30a8), 0x91 },
	{ CCI_REG8(0x30ac), 0x28 },
	{ CCI_REG8(0x30af), 0x09 },
	{ CCI_REG8(0x30df), 0x00 },
	{ CCI_REG8(0x3165), 0x00 },
	{ CCI_REG8(0x3169), 0x10 },
	{ CCI_REG8(0x316a), 0x02 },
	{ CCI_REG8(0x31c8), 0xf3 },	/* Exposure-related */
	{ CCI_REG8(0x31d0), 0xf4 },	/* Exposure-related */
	{ CCI_REG8(0x321a), 0x00 },
	{ CCI_REG8(0x3226), 0x02 },
	{ CCI_REG8(0x3256), 0x01 },
	{ CCI_REG8(0x3541), 0x72 },
	{ CCI_REG8(0x3516), 0x77 },
	{ CCI_REG8(0x350b), 0x7f },
	{ CCI_REG8(0x3758), 0xa3 },
	{ CCI_REG8(0x3759), 0x00 },
	{ CCI_REG8(0x375a), 0x85 },
	{ CCI_REG8(0x375b), 0x00 },
	{ CCI_REG8(0x3832), 0xf5 },
	{ CCI_REG8(0x3833), 0x00 },
	{ CCI_REG8(0x38a2), 0xf6 },
	{ CCI_REG8(0x38a3), 0x00 },
	{ CCI_REG8(0x3a00), 0x80 },
	{ CCI_REG8(0x3d48), 0xa3 },
	{ CCI_REG8(0x3d49), 0x00 },
	{ CCI_REG8(0x3d4a), 0x85 },
	{ CCI_REG8(0x3d4b), 0x00 },
	{ CCI_REG8(0x400e), 0x58 },
	{ CCI_REG8(0x4014), 0x1c },
	{ CCI_REG8(0x4041), 0x2a },
	{ CCI_REG8(0x40a2), 0x06 },
	{ CCI_REG8(0x40c1), 0xf6 },
	{ CCI_REG8(0x40c7), 0x0f },
	{ CCI_REG8(0x40c8), 0x00 },
